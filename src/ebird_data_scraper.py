...
def get_charts():
    species_list = open("../res/ont_species_6letter_likely.txt", 'r').read().splitlines()
    ...
    for species in species_list:
        ...
        # Write to file
        f = open("ontario\\" + "ALL_YEARS_" + species_fixed + ".txt",
                 "w", encoding="utf-8")
        f.write(r.text)
        f.close()
        ...
        # Write to file
        f = open("ontario\\" + "20_YEARS_" + species_fixed + ".txt",
                 "w", encoding="utf-8")
        f.write(r.text)
        f.close()
        ...
        # Write to file
        f = open("toronto\\" + "ALL_YEARS_" + species_fixed + ".txt",
                 "w", encoding="utf-8")
        f.write(r.text)
        f.close()
        ...
        # Write to file
        f = open("toronto\\" + "20_YEARS_" + species_fixed + ".txt",
                 "w", encoding="utf-8")
        f.write(r.text)
        f.close()
